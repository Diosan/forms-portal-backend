...
export const makePDFsendToEfiling = async (req, res) => {
  console.log("========================   makePDFsendToEfiling  ========================",req.body);
  if (
    !req.body ||
  ...
  try {
    ...
    // req.body.isOathOrAffirmation === null || req.body.isOathOrAffirmation.toLowerCase() === "oath" ? true : false;

    // if(req.body.isOathOrAffirmation === null) {
    //   const isOath = true;
    // } else {
    //   const isOath = req.body.isOathOrAffirmation.toLowerCase() === "oath";
    // }
    ...
    console.log("END OF Submission Details .+++++++++++++++++++++++++++++++++++++++++++++++++++++");
    console.log("END OF Submission Details .+++++++++++++++++++++++++++++++++++++++++++++++++++++");
    ...
    const submissionType = result?.type ?? "";
    ...
    <div class="signature-container">
        ...
        <div
        class="signature-format"
        style="background-color: rgb(236, 247, 255); padding:5px 5px; margin-top: 10px; max-width:300px; border: 1px solid rgb(0,0,0)"
        >
        <div style="display: flex; font-family:Calibri, Arial, Helvetica, sans-serif" >
            <div class="col-6 col" style="width:150px;">
            <div class="logo-placeholder d-flex swf-sign">
  ...
  if (!["indictment", "indictment_preliminary_completed"].includes(submissionType)) {
    ...
    let printAdditionalNotes = additionalNotes !== "" ? `
        <div
        id="acnhor-sign"
        class="avoid-break-inside"
        style="
