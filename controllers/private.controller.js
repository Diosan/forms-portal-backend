...
export const createPrivate = async (req, res) => {
    console.log('Creating new user for private complaint');
    let submission = await SubmissionModel.create(req.body);
    console.log('Create new private complaint result: ', submission);
...
export const createUser = async (req, res) => {
    ...
    console.log('Create new user for private complaint result: ', user);
